...
/**
 * Define a new type that includes all the fiekds within Wallet
...
export default function WalletList({ address }: { address: string }) {
  // Declare a state variable wallets which keeps track of WalletWithTxnxCount for a give EOA address
